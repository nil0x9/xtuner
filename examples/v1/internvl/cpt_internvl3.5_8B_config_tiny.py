...
# meta_data_path = '/mnt/shared-storage-user/gaozhangwei/workspace_glx/data/export_meta_internvl3_5_cpt_tiny.json'
# model_path = "/mnt/shared-storage-user/intern7shared/wangweiyun/OpenGVLab-rc1-hf/InternVL3_5-8B-INIT-HF" # 转换后的权重（hf官方格式）
# work_dir = "/mnt/shared-storage-user/intern7shared/internvl_a4s/xtuner_saved_model/internvl3.5-test/internvl3.5-8B-cpt-tiny-bs96-epoch1-lr1e-5"
# tokenizer_cache_dir = "/mnt/shared-storage-user/intern7shared/internvl_a4s/xtuner_tokenizer_cache/internvl3.5-test/slow_tokenize_cpt_ml_32k_tokenizer"

# 路径配置
ceph_config = "/mnt/shared-storage-user/gaozhangwei/workspace_glx/petreloss.conf"
meta_data_path = '/mnt/shared-storage-user/gaozhangwei/workspace_glx/data/export_meta_internvl3_5_cpt_tiny_v2.json'
model_path = "/mnt/shared-storage-user/intern7shared/wangweiyun/OpenGVLab-rc1-hf/InternVL3_5-8B-INIT-HF" # 转换后的权重（hf官方格式）
work_dir = "/mnt/shared-storage-user/intern7shared/internvl_a4s/xtuner_saved_model/internvl3.5_v2/internvl3.5-8B-cpt-tiny-bs96-epoch1-lr1e-5"
tokenizer_cache_dir = "/mnt/shared-storage-user/intern7shared/internvl_a4s/xtuner_tokenizer_cache/internvl3.5_v2/slow_tokenize_cpt_ml_32k_tokenizer"
