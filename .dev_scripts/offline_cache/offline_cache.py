...
def cache_worker(dataset_config_list: DatasetConfigList, tokenizer_path: str, worker_id: int, tracker):
    ...
    Args:
        ...
        tracker: Ray Actor reference to the ProgressTracker for reporting progress
    """
    import os
    import socket
