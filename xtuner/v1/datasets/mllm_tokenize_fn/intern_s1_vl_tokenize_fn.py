                ...
                for c in content:
                    if c.type == "text":
                        ...
                        for i in range(video_cnt):
                            ...
                            special_tokens = "\n".join(
                                [
                                    f"Frame-{frame_idx + 1}: {image_tokens}"
    ...
    def video_get_item(self, data_item: dict, media_root: str = "") -> InternS1DataItem:
        ...
        for video_path in self._video_path:
            ...
            if video_path.split('/')[-1] in [
                ...
                "0021_Rear_Window_00.20.06.996-00.20.14.058.avi",
                "0021_Rear_Window_00.20.39.211-00.20.41.571.avi",
                "0021_Rear_Window_00.20.41.804-00.20.43.349.avi",
                "0021_Rear_Window_00.20.59.194-00.21.01.246.avi",
                "0021_Rear_Window_00.21.26.229-00.21.28.873.avi",
                "S030C002P011R002A099_rgb.avi",
                "S030C002P011R002A100_rgb.avi",
                "6982049422293159183-Scene-001.mp4",
                "v_TK5FnYshy10.mp4",
                "v_TK5FnYshy10.mp4",
                "1t76iw_pimQ-Scene-004.mp4",
                "3AgwNKG83c8-Scene-004.mp4",
